...
public class ServicioPeliculasArchivo implements IServicioPeliculas{
    ...
    public void listarPeliculas() {
        ...
        try {
            ...
            // Leeemos todas las linea
            while (linea != null) {
                var pelicula = new Pelicula(linea);
                System.out.println(pelicula);
                // Antes de terminal el ciclo volvermos a leer la siguiente linea
                linea = entrada.readLine();
            }
            // cerrar el archivo
            entrada.close();
    ...
    public void buscarPelicula(Pelicula pelicula) {
        ...
        try {
            ...
            while (lineaTexto != null) {
                // Buscamos sin importa mayusculas o minusculas
                if(peliculaBuscar != null && peliculaBuscar.equalsIgnoreCase(lineaTexto)){
                    encontrada = true;
                    break;
                }

                // leemos la siguiente linea antes de la sigueinte iteracion
            ...
            if(encontrada){
                ...
                System.out.println("No se encontro el pelicula " + pelicula.getNombre());
            }
            entrada.close();
